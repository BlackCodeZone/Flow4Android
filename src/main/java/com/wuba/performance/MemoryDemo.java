...
public class MemoryDemo extends JPanel {
    ...
    class DataGenerator extends Timer implements ActionListener {
        ...
        public void actionPerformed(ActionEvent actionevent) {
            ...
            MemoryDemo.this.addTotalObservation((double) l_0_);
            MemoryDemo.this.addFreeObservation((double) l);
        }
    }

    public MemoryDemo(int i) {
...
//                "SansSerif", 1, 24), xyplot, true);
        JFreeChart jfreechart = ChartFactory.createTimeSeriesChart("1", "2", "3", timeseriescollection, true, true, false);
    ...
    public static void main(String[] strings) {
        ...
        MemoryDemo memoryusagedemo = new MemoryDemo(30000);
